...
import {project, SectionId} from '../../data/data';
...
const Portfolio: FC = memo(() => {
  return (
    ...
    //     <h2 className="self-center text-xl font-bold text-white">Personal Corner</h2>
    //     <p className="self-center text-white md:text-base sm:text-sm">As mentioned before, I love custom mechanical keyboards, and this corner is just to show off some of my work</p>
